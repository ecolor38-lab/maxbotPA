...
Верни только промпт на английском, без дополнительных пояснений.`;
  ...
  generateDemoSummary(articles) {
    return `🔬 Прорыв в лечении псориатического артрита: что нового в 2025 году?

Последние исследования открывают новые горизонты в борьбе с псориатическим артритом. Вот ключевые достижения, которые меняют жизнь пациентов:

💊 Новые биологические препараты
Клинические испытания III фазы показали впечатляющие результаты: новый ингибитор IL-17 улучшает симптомы у 78% пациентов уже через 12 недель терапии. Препарат продемонстрировал не только высокую эффективность, но и благоприятный профиль безопасности.

🤖 Искусственный интеллект на страже здоровья
Ученые разработали AI-алгоритм, который с точностью 85% предсказывает развитие артрита у пациентов с псориазом на 5 лет вперед. Система анализирует более 200 биомаркеров, что позволяет начать профилактическое лечение до появления симптомов.

🎯 Персонализированный подход
Генетическое тестирование теперь помогает врачам выбрать наиболее эффективный препарат для каждого пациента, увеличивая вероятность положительного ответа на терапию на 40%.

Эти достижения дают реальную надежду миллионам людей, живущих с псориатическим артритом. Ранняя диагностика, персонализированное лечение и инновационные препараты делают болезнь контролируемой.

💬 Живете с ПсА? Поделитесь своим опытом в комментариях!`;
  }
}
