...
export class AISummarizer {
  ...
  createPrompt(articlesText) {
    ...
    if (isRussian) {
      return `Ты - деловой редактор. Пиши ТОЛЬКО на русском языке!

НОВОСТИ:
${articlesText}

ЗАДАЧА: Перепиши эти новости в деловой стиль на русском языке.

КРИТИЧЕСКИ ВАЖНО:
1. ТОЛЬКО РУССКИЙ ЯЗЫК! Ни слова на английском!
2. Сохраняй факты: цифры, названия, даты
3. Объем: 450-600 символов максимум
4. Конкретика из новостей

СТРУКТУРА:
- Заголовок (эмодзи + тема)
- 2-3 коротких абзаца про ключевые новости
- БЕЗ хештегов
- БЕЗ призывов подписаться

Верни только текст поста на русском языке.`;
    } else {
